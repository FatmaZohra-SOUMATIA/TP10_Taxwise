...
public class QueryBox {
        ...
        public static final String AJOUTER_TRANCHE_REVENU = "INSERT INTO TranchesRevenu (autorite_fiscale_id, tranche_min, tranche_MAX, taux_imposition)\n" +
                "VALUES (?, ?, ?, ?)";
    ...
    static String SUPPRIMER_TRANCHE_REVENU_PAR_NOM_AUTORITE = "DELETE FROM TranchesRevenu tr " +
            ...
            "WHERE af.nom LIKE ?";
        //requete sql
        static String TROUVER_TRANCHE_REVENU_PAR_NOM_AUTORITE = "SELECT tr.id, tr.autorite_fiscale_id, tr.tranche_min, tr.tranche_max, tr.taux_imposition " +
